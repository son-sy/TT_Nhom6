namespace QuanLyNhanSu
{
    partial class FormTK
    {
		...
		private void InitializeComponent()
		{
			...
			// txtMatKhau
			// 
			txtMatKhau.Location = new Point(576, 189);
			...
			cboVaiTro.Location = new Point(576, 99);
			...
			btnSua.Location = new Point(520, 247);
			btnSua.Name = "btnSua";
			...
			btnLamMoi.Location = new Point(717, 247);
			btnLamMoi.Name = "btnLamMoi";
			btnLamMoi.Size = new Size(129, 56);
			btnLamMoi.TabIndex = 7;
			btnLamMoi.Text = "Xóa ô nhập";
			...
			label3.Location = new Point(482, 107);
			label3.Name = "label3";
			...
			Matkhau.Location = new Point(461, 196);
			...
			btnThoat.Location = new Point(772, 12);
